...
import { ArrowLeft, AlertCircle, Filter, Download, Award, CheckCircle2 } from "lucide-react";
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
          ...
          <TabsContent value="keseluruhan" className="mt-4">
                ...
                return (
                  <Card key={field} className={`border-2 ${g.bgColor}`}>
                    <CardContent className="p-4 text-center">
                      ...
                      <Badge className={`${g.bgColor} ${g.color} mt-1`}>Grade {g.grade}</Badge>
                    </CardContent>
                  </Card>
                );
              })}
            ...
            {(() => {
              ...
              const overallRec = getOverallRecommendation(overallPct);
                  ...
                  <Card key={field} className={`border-2 ${cfg.bgColor}`}>
                    <CardHeader>
                      <CardTitle className="text-base flex items-center gap-2">
                        <span className={cfg.color}>{cfg.icon}</span>
                        {cfg.label}
                        <Badge className={`${g.bgColor} ${g.color} ml-2`}>Grade {g.grade} — {problemPercentage}%</Badge>
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
