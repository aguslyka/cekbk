                        ...
                        {cItems.length > 0 && (
                          <div className="mt-2 flex items-center gap-2">
                            <div className="flex-1 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                              <div
                                className={`h-full rounded-full transition-all ${cTidakPct === 0 ? "bg-emerald-500" : cTidakPct <= 10 ? "bg-teal-500" : cTidakPct <= 25 ? "bg-amber-500" : cTidakPct <= 50 ? "bg-orange-500" : "bg-rose-500"}`}
            ...
            <>
              <div id="kartu-konseling-content" className="bg-white p-6 text-gray-900 text-sm border rounded-lg">
                ...
                <ProfilSiswa student={{
                  ...
                  createdAt: kartuCounseling.student.createdAt || null,
                }} />
