...
import { useAuth, apiFetch, FIELD_CONFIG, ProfilSiswa, handlePrintPDF, type View, type UserData } from "@/lib/app-shared";
                    ...
                    <Card key={rIdx} className="border-2">
                      <CardHeader className="pb-2">
                        ...
                        <p className="text-xs text-gray-500">
                          IYA: {iyaAnswers.length} / {answers.length} ({answers.length > 0 ? Math.round((iyaAnswers.length / answers.length) * 100) : 0}%)
                        </p>
                      </CardHeader>
                      <CardContent>
                        <Table>
                          ...
                          <TableBody>
                            {answers.map((a: any, aIdx: number) => (
                              <TableRow key={aIdx} className={a.value === "IYA" ? "bg-red-50" : ""}>
                                ...
                                <TableCell className="text-center">
                                  {a.value === "IYA" ? (
                                    <Badge className="bg-red-100 text-red-700 hover:bg-red-100">IYA</Badge>
                                  ) : (
